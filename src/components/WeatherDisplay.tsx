...
export const WeatherDisplay = ({ data }: WeatherDisplayProps) => {
  return (
    <div className="text-center animate-in fade-in zoom-in duration-500">
      ...
      <h1 className="text-7xl font-black mb-2">{Math.round(data.main.temp)}°C</h1>
      <h2 className="text-2xl font-medium tracking-wide mb-8 uppercase italic">{data.name}</h2>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-white/10 p-4 rounded-3xl flex flex-col items-center border border-white/5">
          ...
          <span className="font-bold text-sm capitalize text-center leading-tight">
